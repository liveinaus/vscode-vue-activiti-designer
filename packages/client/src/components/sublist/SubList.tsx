...
import "./sublist.css";
import { SubListState, TableColumn } from "./type";
                    ...
                    <ElForm ref="form" {...formProps}>
                        <ElTable {...tableProps} data={sublistState.data}>
                            {props.columns.map((column) => {
                                ...
                                if (
                                    ...
                                    const editComponentBuilder =
                                        rawColum.editComponent ||
                                        getDefaultEditComponent();
                                    const slots = {
                                        default: (scope: any) => {
                            ...
                            <ElTableColumn
                                ...
                                v-slots={this.actionColumnProps.vSlots}
                            />
                        </ElTable>
                    </ElForm>
                )}
            ...
            default: (scope: any) => (
                <div class="sublist-actions">
                    {state.editing && scope.$index === state.editIndex ? (
                        <div>
                            <span
                                class="sublist-confirm sublist-btn"
                            ...
                            <span
                                class="sublist-cancel sublist-btn"
 ...
 */
function getDefaultEditComponent(): (
    scope: any,
    state: SubListState<any>
) => JSX.Element {
